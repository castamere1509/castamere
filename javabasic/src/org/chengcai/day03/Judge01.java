 ...
 * 
 *以上关系运算符号得出的结果都是boolean类型，要么是true成立,要么是false不成立
 *
 *如果是String类型去做对比使用 A.equals(B) 方法
 *
 */
public class Judge01 {
	public static void main(String[] args){
		...
		String str1 ="abc";
		String str2 ="abd";
		boolean bo7 = str1 ==str2;//一般在java里面不会这么比较String类型,不要这样写
		System.err.println(bo7);//false
		
		//一般使用字符串.equals(被比较的数据)，可以让这个字符串对比任何类型

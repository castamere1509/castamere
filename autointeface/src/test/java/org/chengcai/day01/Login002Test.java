...
public class Login002Test {
	@DataProvider
	public Object[][] data(){
		Object[][] obj={
				{"lixiaohua","123@abc","登录成功"},//正确流程
				{"","123@abc","用户名不能为空"},    //用户名为空
				{"lixiaohuaa","123@abc","登录失败"},//用户名错误
				{"lixiaohua","","密码不能为空"},   //密码为空的场景
				{"lixiaohua","123@abcde","登录失败"}//密码错误的场景
		};
	...
	public void loginGet(String username,String mima,String exp) throws ClientProtocolException, IOException{
		...
		System.out.println(entity);//这个entity是转换为字符串的响应体
		//7.添加断言   使用包含断言

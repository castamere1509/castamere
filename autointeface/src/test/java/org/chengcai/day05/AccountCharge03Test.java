...
public class AccountCharge03Test {
	
	
	@DataProvider
	public Object[][] data(){
		                 //读取根目录下test_case.xlsx        
		Object[][] obj=ExcelUtils.read("/test_case.xlsx", 8, 2, 2, 1, 7);//正常转账
		return obj;
	}
...
//----------------------------------------------------------------------------------------------//
		...
		Object[] obj3={uid,"小花","123456","工商银行",10000};
		...
		Object[] obj5={uid2,"小花花","666666","工商银行",0};

...
import org.chengcai.tools.Sign01Util;
import org.chengcai.tools.SignUtil;
import org.testng.Assert;

public class TokenUid03Utils {
	
	public static String getUserid01(String username,String mima){
		String id=null;	
		try{			
			//获取sign值，这是登录必须要有的参数 [{"userid":550,"token":"fa324528d9fc4427824e6b26ebe7f0ae","result":"登录成功"}]
			String sign =Sign01Util.getSign(username, mima);	           			
			//登录流程
			...
			id =entity.substring(c+8,d-2);
				...
				e.printStackTrace();
				System.err.println("因为异常导致id截取失败");
			}		
			return id;
	}
	
	//封装获取token的方法
	public static String getToken01(String username,String mima){
		String tk=null;	
		try{			
			//获取sign值，这是登录必须要有的参数
			String sign =Sign01Util.getSign(username, mima);	           			
			...
			tk =entity.substring(a+8,b-3);
				...
				e.printStackTrace();
				System.err.println("因为异常导致Token截取失败");
			}		
			return tk;
	}
	...
	public static void main(String[] args) {
		getUserid01("lixiaohua","123@abc");
		getToken01("lixiaohua","123@abc");

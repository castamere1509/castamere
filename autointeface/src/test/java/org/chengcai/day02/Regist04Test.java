...
public class Regist04Test {
	
	@DataProvider
	public Object[][] data(){
		                 //读取根目录下test_case.xlsx  第1页   第2行到第6 行   第3列到第5类
		Object[][] obj=ExcelUtils.read("/test_case.xlsx", 3, 2, 12, 1, 6);
		return obj;
	}

	
	@Test(dataProvider="data")
	public void loginPost(String caseId,String casePs,String username,String mima,String newmima,String exp) throws ClientProtocolException, IOException, SQLException{
		...
		HttpPost post = new HttpPost("http://localhost:8080/interfacedemo/update");				

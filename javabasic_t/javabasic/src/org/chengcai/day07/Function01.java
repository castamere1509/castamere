 ...
 *   4.如果有声明一个方法有返回，那么这个方法必须运行return，而且return的必须是声明的返回类型
...
//有返回值案例
	...
	//设计一个登录功能
	//公开   静态的  返回String  方法名login  入参username和password
...
//无返回无入参方法案例
 ...
 //-----------------------以上是方法，以下是使用main方法调用--------------------------------------------------------   
	...
	//调用有返回值方法
		...
		//double dbe = areas1(3.5,1.7);//这行代码报错，调用的方法无返回值，没有值给dbe,所以报错了
